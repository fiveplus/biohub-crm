...
public class SystemConfigListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try{
			...
			context.setAttribute("STAGES", Resource.STAGES);
			context.setAttribute("DEMANDS", Resource.DEMANDS);
			context.setAttribute("METHODS", Resource.METHODS);
			context.setAttribute("RATES", Resource.RATES);
