...
<![endif]-->
		...
		<script type="text/javascript">
			...
			function login(){
				...
				$("#login_post").attr("action",$("#login_post").attr("action")+"?remember="+remember);
			...
			$(document).ready(function(){
				var loginName = getCookieVal("loginName");
				var password = getCookieVal("password");
				
				document.getElementsByName("loginName")[0].value = loginName;
