	...
	<fms:Content contentPlaceHolderId="main">
						...
						<div class="col-xs-12">
										...
										<tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="green" href="javascript:recoverHTML('${contextPath}/admin/custom/recover/${c.id}')">
														<i class="icon-pencil bigger-130"></i>
													</a>
														
													<a class="red" href="javascript:deleteHTML('${contextPath}/admin/custom/delete/${c.id}')">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="javascript:recoverHTML('${contextPath}/admin/custom/recover/${c.id}')" class="tooltip-success" data-rel="tooltip" title="Edit">
																	<span class="green">
							...
							<div class="modal-footer no-margin-top">
								<ul class="pagination pull-right no-margin" id="page">
									...
									<c:if test="${pu.pageNum!=1}">
										<li class="prev">
											<a href="${contextPath}/admin/custom/dellist/1">
												<i class="icon-double-angle-left"></i>
											</a>
										</li>
									</c:if>
									<c:forEach items="${pc.pageList}" var="p">
										...
										<c:if test="${p!=pu.pageNum}">
											<li>
												<a href="${contextPath}/admin/custom/dellist/${p}">${p}</a>
											</li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pu.pageNum!=pu.lastPage}">
										<li class="next">
											<a href="${contextPath}/admin/custom/dellist/${pu.lastPage}">
												<i class="icon-double-angle-right"></i>
											</a>
										</li>
									</c:if>
		...
		<script type="text/javascript">
			function recoverHTML(url){
				bootbox.confirm("确认恢复该客户吗？",function(result){
					if(result){
						$.ajax({
							url:url,
							type:"POST",
