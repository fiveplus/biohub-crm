		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							<form action="${contextPath}/admin/custom/update" role="form" class="form-horizontal" method="post" id="form_post" >
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<!-- <span style="color:#b399a6">&nbsp;&nbsp;Please enter telephone</span>  -->
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<span style="color:#b399a6">&nbsp;&nbsp;Please enter E-mail</span>
									</div>
								</div>
								<div class="space-4"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="Linked-in URL" class="col-xs-10 col-sm-5" name="linkedin" value="${custom.linkedin}" />
										<!-- <span style="color:#b399a6">&nbsp;&nbsp;Please enter Linked-in</span> -->
									</div>
								</div>
								<div class="space-4"></div>
