				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<span>项目领域列表</span>
							<button class="btn" style="float:right;margin-top: -12px;" onclick="go_url('${contextPath}/admin/projectdomain/add')" >
								<i class="icon-pencil align-top bigger-125"></i>项目领域新增 (Project Domain Add)
							</button>
							</h3>
										...
										<tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="green" href="${contextPath}/admin/projectdomain/upt/${d.id}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="${contextPath}/admin/projectdomain/upt/${d.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																	<span class="green">
							...
							<div class="modal-footer no-margin-top">
								<ul class="pagination pull-right no-margin" id="page">
									...
									<c:if test="${pu.pageNum!=1}">
										<li class="prev">
											<a href="${contextPath}/admin/projectdomain/list/1">
												<i class="icon-double-angle-left"></i>
											</a>
										</li>
									</c:if>
									<c:forEach items="${pc.pageList}" var="p">
										...
										<c:if test="${p!=pu.pageNum}">
											<li>
												<a href="${contextPath}/admin/projectdomain/list/${p}">${p}</a>
											</li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pu.pageNum!=pu.lastPage}">
										<li class="next">
											<a href="${contextPath}/admin/projectdomain/list/${pu.lastPage}">
												<i class="icon-double-angle-right"></i>
											</a>
										</li>
									</c:if>
