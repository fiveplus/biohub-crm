				...
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<span>项目类型列表</span>
							<button class="btn" style="float:right;margin-top: -12px;" onclick="go_url('${contextPath}/admin/projectype/add')" >
							<i class="icon-pencil align-top bigger-125"></i>项目类型新增 (Project Type Add)</button>
							</h3>
							...
							<div class="table-responsive">
								<table id="sample-table-2" class="table table-striped table-bordered table-hover">
									...
									<tbody>
										<c:forEach items="${pu.list}" var="pt" >
										<tr>
											<td class="center">
												<label>
											...
											<td>
												<a href="javascript:void(0)">${pt.id}</a>
											</td>
											<td>${pt.name}</td>
											<!-- <td class="hidden-480">${d.updateCount}</td> -->
											<td><date:date value="${pt.createTime}" /></td>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													...
													<a class="green" href="${contextPath}/admin/projectype/upt/${pt.id}">
												...
												<div class="visible-xs visible-sm hidden-md hidden-lg">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
															...
															<li>
																<a href="${contextPath}/admin/projectype/upt/${pt.id}" class="tooltip-success" data-rel="tooltip" title="Edit">
																	<span class="green">
							...
							<div class="modal-footer no-margin-top">
								<ul class="pagination pull-right no-margin" id="page">
									...
									<c:if test="${pu.pageNum!=1}">
										<li class="prev">
											<a href="${contextPath}/admin/projectype/list/1">
												<i class="icon-double-angle-left"></i>
											</a>
										</li>
									</c:if>
									<c:forEach items="${pc.pageList}" var="p">
										...
										<c:if test="${p!=pu.pageNum}">
											<li>
												<a href="${contextPath}/admin/projectype/list/${p}">${p}</a>
											</li>
										</c:if>
									</c:forEach>
									...
									<c:if test="${pu.pageNum!=pu.lastPage}">
										<li class="next">
											<a href="${contextPath}/admin/projectype/list/${pu.lastPage}">
												<i class="icon-double-angle-right"></i>
											</a>
										</li>
									</c:if>
