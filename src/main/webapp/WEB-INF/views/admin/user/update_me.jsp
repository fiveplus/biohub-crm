							...
							<form action="${contextPath}/admin/user/updateuser" role="form" class="form-horizontal" method="post" id="form_post" >
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										<c:if test="${us.picture != ''}">
											<img class="nav-user-photo" src="${contextPath}/${us.picture}" width="100" height="100" alt="${us.userName}" style="cursor: hand;" onclick="go_url('${contextPath}/admin/user/head')" />
										</c:if>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-1" placeholder="所属部门" readonly="readonly" class="col-xs-10 col-sm-5"  value="${us.deptName}" />
									</div>
								</div>
								<div class="space-4"></div>
