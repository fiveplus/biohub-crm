	...
	<fms:Content contentPlaceHolderId="main">
		<div class="breadcrumbs" id="breadcrumbs">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="${contextPath}/admin/permission/list/1">权限管理</a>
				</li>
		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-12">
							<form action="${contextPath}/admin/permission/save" role="form" class="form-horizontal" method="post" id="form_post">
